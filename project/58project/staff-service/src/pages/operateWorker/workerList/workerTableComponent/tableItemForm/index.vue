<template>
    <div style="width: 1100px;">
        ...
        <div>
            <show-button :currentPage="currentPage" :currentWorkerItem="currentWorker"></show-button>
            <edit-button :currentPage="currentPage" :currentWorker="currentWorker"></edit-button>
            <change-status-button @updateTable="$emit('updateTable')" :currentWorker="currentWorker"></change-status-button>
        </div>
    </div>
</template>
