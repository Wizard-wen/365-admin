    ...
    <div class="order-box">
        <div class="title">
            <div class="title-contains">
                <div class="left">审核新服务人员</div>
                <div class="control" @click="goNewWorkerListPage">审核新服务人员列表</div>
            </div>
        </div>
        <div class="order-list">
            ...
            <div class="order-card" v-if="staff_application.length < 6">
                <div class="more-box" @click="goNewWorkerListPage">
