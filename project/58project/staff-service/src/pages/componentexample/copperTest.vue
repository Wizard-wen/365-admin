    ...
    <div>
        ...
        <el-upload 
            ...
            <div 
                class="reupload" 
                ref="uploading" 
                :style="{width:reuploadWidth+'px',height:reuploadWidth+'px','line-height':reuploadWidth+'px','font-size':reuploadWidth/5+'px'}">上传中..</div>
            <div 
                class="reupload" 
                ref="failUpload" 
                :style="{width:reuploadWidth+'px',height:reuploadWidth+'px','line-height':reuploadWidth+'px','font-size':reuploadWidth/5+'px'}">上传失败</div>
        </el-upload>
        <!-- 多图片预览弹窗 -->
        ...
        <!-- 剪裁组件弹窗 -->
        <el-dialog v-if="cropperModel" :visible.sync="cropperModel" width="1100px" :before-close="beforeClose">
            <Cropper 
                :img-file="file" 
                ref="vueCropper" 
...
export default {
  ...
  methods: {
    ...
    async imgUpload(formData) {
        ...
        // const res = await axios.post('/admin/common/uploadImage',{
        //     data: formData,
        // },{
        //     headers: {
        //         'Content-Type': 'multipart/form-data'
