<template>
    <div class="search-box">
        <el-form :inline="true" size="mini" ref="localQueryedForm" label-width="90px" :model="localQueryedForm" class="account-form">
            ...
            <el-form-item label="参加培训" prop="course">
                <el-cascader
                    v-model="localQueryedForm.course"
                    :options="queryForm.skill"
                    :props="cascaderProps"
                    :show-all-levels="false"
                    filterable
            ...
            <el-form-item  label="技能证书" prop="paper_category">
                <el-select 
