    ...
    <el-dialog
        ...
        <el-form :model="determinateContractForm" label-width="120px" :rules="determinateContractRules" ref="determinateContractForm">
            <el-form-item label="终止事由" prop="terminate_reason">
                <el-input v-model="determinateContractForm.terminate_reason"></el-input>
            </el-form-item>
            ...
            <el-form-item label="工作天数" prop="service_days">
                <el-input v-model="determinateContractForm.service_days"></el-input>
            </el-form-item>
            <el-form-item label="日工资" prop="daily_wage">
                <el-input v-model="determinateContractForm.daily_wage"></el-input>
            </el-form-item>
            <el-form-item label="首月工资合计" prop="total_wage">
                <el-input v-model="determinateContractForm.total_wage"></el-input>
            </el-form-item>
            <el-form-item label="服务费扣除" prop="service_cost">
                <el-input v-model="determinateContractForm.service_cost"></el-input>
            </el-form-item>
            <el-form-item label="其他扣除" prop="other_cost">
                <el-input v-model="determinateContractForm.other_cost"></el-input>
            </el-form-item>
            <el-form-item label="扣除事由" prop="cost_reason">
                <el-input v-model="determinateContractForm.cost_reason"></el-input>
            </el-form-item>
            <el-form-item label="实发工资" prop="real_wage">
                <el-input v-model="determinateContractForm.real_wage"></el-input>
            </el-form-item>
            <el-form-item label="返还客户金额" prop="return_wage">
                <el-input v-model="determinateContractForm.return_wage"></el-input>
            </el-form-item>
        </el-form>
