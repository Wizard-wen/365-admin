            ...
            <el-table 
                ...
                <el-table-column  label="订单状态" prop="type" align="center" width="150">
                    <template slot-scope="scope">
                        <table-tag-component 
                        v-if="orderFormConfig.type" 
                        :propList="orderFormConfig.type" 
                ...
                <el-table-column  label="下单客户" prop="order_user_name" align="center" width="150">
                    <template slot-scope="scope">
                        <el-popover trigger="click" placement="top">
                            <p>{{ scope.row.order_user_name }}</p>
                            <p slot="reference" class="overCellText">{{ scope.row.order_user_name }}</p>
                        </el-popover>
                    </template>
                </el-table-column>

                <el-table-column  label="下单客户电话" prop="order_user_phone" align="center" width="150">
                    <template slot-scope="scope">
                        <el-popover trigger="click" placement="top">
                            <p>{{ scope.row.order_user_phone }}</p>
                            <p slot="reference" class="overCellText">{{ scope.row.order_user_phone }}</p>
                        </el-popover>
                    </template>
                </el-table-column>
                ...
                <el-table-column  label="来源人" prop="apply_manager_name" align="center" width="150" :formatter="apply_manager_nameFomatter"></el-table-column>
...
<script>
    ...
    export default {
        ...
        methods: {
             ...
             * 来源人转换
             */
            apply_manager_nameFomatter(row, column){
