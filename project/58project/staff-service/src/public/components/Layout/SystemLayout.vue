        ...
        <div class="">
            ...
            <div class="content">
                ...
                <div
                    ...
                    ref="content">
                    <div class="router-contains abc" ref="contains" >
...
//图片
import minePic from './images/header.png'
...
export default {
    ...
    watch: {
        $route: {
            handler: function(val, oldVal){
                if(this.$store.state.loginModule.user.routerNavigator[val.path])
                    this.breadcrumb = this.$store.state.loginModule.user.routerNavigator[val.path]
                else 
                    console.log(-1);
            },
            // 深度观察监听
    ...
    async mounted(){
        //面包屑导航
        this.breadcrumb = this.$store.state.loginModule.user.routerNavigator[this.$route.path]
    }
}
</script>
