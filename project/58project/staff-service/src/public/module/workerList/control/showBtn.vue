    ...
    methods: {
        ...
        setShowType(){
            if(this.workerListType == 'total'){
                return {type: 1, path: '/worker/workerItemShow',}
            } else if(this.workerListType == 'return'){
                return {type: 2, path: '/worker/workerItemShow',}
            } else if(this.workerListType == 'warning'){
                return {type: 3, path: '/worker/workerItemShow',}
            } 
            // else if(this.workerListType == 'apply'){
            //     return 4
            // } 
            else if(this.workerListType == 'seller'){
                return {type: 5, path: '/sale/saleWorkerShow',}
            } else if(this.workerListType == 'match'){
                return {type: 6, path: '/sale/saleWorkerShow',}
            }
        },
        /**
         * 查看服务人员详情
        ...
        showWorker(){
            this.$router.push({
                ...
                query: {
                    ...
                    order_id: this.setShowType().type == 6? this.$route.query.order_id: 0
                }
            })
        },
    }
