...
import {
    searchCustomAdItem,
} from '@/pages/operateCustom/adPositionList/ICustomAdList'
import {
    customAdItem,
...
export const adService = {
     ...
     * 请求列表数据
     */
    getAdPositionList(queryObject:searchCustomAdItem):Promise<any>{
    ...
    /**
     * 
     * @param ad_position_resource_id 
     */
    getAdPositionResource(ad_position_resource_id:any){
        return apiRequestAd.getAdPositionResource(ad_position_resource_id)
    },
    /**
     * 
     * @param adPictureForm 
     */
    editAdPositionResource(adPictureForm:any){
        return apiRequestAd.editAdPositionResource(adPictureForm)
    },
    /**
     * 
     * @param id 
     */
    deleteAdPositionResource(id:any){
        return apiRequestAd.deleteAdPositionResource(id)
    },
    /**
     * 
     */
