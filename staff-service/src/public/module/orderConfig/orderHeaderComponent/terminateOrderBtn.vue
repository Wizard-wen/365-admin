<template>
    <div style="display: inline-block">
        <el-button type="danger" size="mini" @click="openDeterminateOrderDialog">终止订单</el-button>
        <!-- 终止订单弹出框 -->
...
<script>
import terminateOrderDialog from './terminateOrderBtn/terminateOrderDialog.vue'
export default {
    components: {
